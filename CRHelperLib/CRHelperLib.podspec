#
#  Be sure to run `pod spec lint CRHelperLib.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source_files  = "CRHelperLib/CRHelperLib/*.{h,m}"
  ...
  # spec.frameworks = "MJRefresh", "AFNetworking", "SDWebImage", "Masonry"
