...
+ (instancetype)alertControllerWithTitle:(NSString *)title message:(NSString *)message{
    ...
    UIAlertAction * confirm = [UIAlertAction actionWithTitle:Alert_cancel style:UIAlertActionStyleDefault handler:nil];
...
+ (instancetype)alertControllerWithTitle:(NSString *)title Message:(NSString *)message confirm:(void (^)(UIAlertAction * _Nonnull))handler{
    ...
    UIAlertAction * confirm = [UIAlertAction actionWithTitle:Alert_confirm style:UIAlertActionStyleDefault handler:handler];
